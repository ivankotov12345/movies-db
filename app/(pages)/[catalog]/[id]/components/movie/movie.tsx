...
import { ModalRating } from '@app/(pages)/components/modal-rating/modal-rating';
import { Poster } from '@app/(pages)/components/poster';
import { RatingButton } from '@app/(pages)/components/rating-button';
