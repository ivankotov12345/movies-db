...
import { CustomPagination } from '@app/(pages)/components/custom-pagination';
import { EmptyList } from '@app/(pages)/components/empty-list';
import { Header } from '@app/(pages)/components/header';
import { MoviesList } from '@app/(pages)/components/movies-list';
import { NoRatedmovies } from '@app/(pages)/components/no-rated-movies';
